...
const RPGender = videogames.filter(videogame => videogame.genders.includes('RPG'));
const score = RPGender.reduce((acc, videogame) => acc + videogame.score, 0);
const averageScore = score / RPGender.length;
console.log(RPGender, score, averageScore)